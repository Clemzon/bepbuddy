        ...
        child: Form(
          ...
          child: ListView(
            children: [
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        controller: TextEditingController(
                          text: '${_pickedDate.month}/${_pickedDate.day}/${_pickedDate.year}',
                        ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          FilledButton(onPressed: _takePhoto, child: const Icon(Icons.camera_alt)),
                          const SizedBox(width: 12),
                          FilledButton.tonal(onPressed: _pickFile, child: const Icon(Icons.attach_file)),
                        ],
                      ),
                      if (_attachment != null) ...[
                        const SizedBox(height: 12),
              ...
              FilledButton(onPressed: _saveInvoice, child: const Text('Save Invoice')),
            ],
          ),
        ),
      ),
